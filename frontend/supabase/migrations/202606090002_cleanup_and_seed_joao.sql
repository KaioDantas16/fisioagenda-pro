...
-- Executa a limpeza de dados de teste ofensivos e insere o paciente João Marcelo Ferreira (Teste) com dados realistas vinculado especificamente ao Lenilson.
...
BEGIN
  ...
  WHERE full_name = 'João Marcelo Ferreira (Teste)';
